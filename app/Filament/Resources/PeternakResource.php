...
class PeternakResource extends Resource
{
    ...
    protected static null|string $navigationLabel = 'Peternak';
    protected static null|string $breadcrumb = 'Peternak';
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Hidden::make('role')->default('peternak'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('user.alamat')->label('Alamat'),
                Tables\Columns\TextColumn::make('status_usaha')->label('Status Usaha'),
            ])
            ->filters([
                //
            ])
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return Peternak::with('user')->where('rph_id', $user->profile->rph_id);
    }
}
